...
public class EmployeeController {
    ...
    // Post-request with several funtions to check that everything is good before
    // saving the NEWemployee.
    ...
    public String saveEmployee(@Valid @ModelAttribute("employee") Employee employee, BindingResult result)
        ...
        // Set the correct salary based on rank and if the employee is manger or ceo
        // (Done from another controller to minimize logic here)
        employee.setSalary(employeeService.calculateSalary(employee));

        // Function that sets variable as "true" if there is a CEO, only if the updated
        // or created employee is marked as CEO otherwise "false".
    ...
    public String deleteEmployee(@PathVariable(value = "id") int id) throws SQLException {
        ...
        if (isTheEmployeeAManager.equals("Yes") && doesTheManagerManageAnEmployee.equals("Yes")) {
            ...
            System.out.println(
                    "You Cant delete this employee becuse this employee is a manager, update the employees this employee manage. Before deleting.");
            return "redirect:/";
